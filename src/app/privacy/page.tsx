...
export default function PrivacyPage() {
  return (
    <LegalDocument
      title="プライバシーポリシー"
      description={`${SITE_NAME}（以下「当サイト」）は、利用者の個人情報および関連情報の取り扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」）を定めます。`}
      ...
      sections={[
          ...
          content: (
            <>
              ...
              <ul className="list-disc space-y-2 pl-5">
                ...
                <li>
                  Cookie・セッション情報（管理者ログイン・店舗ログインの認証状態維持）
                </li>
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                当サイトは、管理者ログインおよび店舗ログインの認証状態を維持するため、httpOnly
                Cookieを使用します。
              </p>
              <p>
        ...
        },
        {
          ...
          content: (
            <p>
              本人から、個人情報の開示・訂正・利用停止・削除等の請求があった場合、法令に従い、適切に対応します。お問い合わせは、ブラック店舗報告フォーム等を通じてご連絡ください。
            </p>
          ),
        },
        {
        ...
        },
        {
          ...
          content: (
            <p>
              本ポリシーに関するお問い合わせは、当サイトのブラック店舗報告フォーム、または管理者が指定する連絡先よりご連絡ください。
            </p>
          ),
        },
      ]}
