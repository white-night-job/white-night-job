    ...
    <div className="space-y-3 sm:space-y-4">
      <section className="hero-panel relative overflow-hidden rounded-3xl px-4 py-6 sm:px-7 sm:py-8 md:px-9 md:py-10">
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          <p className="hero-desc relative mt-4 max-w-md px-1 text-sm leading-relaxed sm:mt-5 sm:text-base">
      ...
      <section className="hero-promo-standalone relative overflow-hidden rounded-2xl sm:rounded-3xl">
