...
export function SupportPromoBanner() {
  return (
    ...
    >
      ...
      <span
        className="absolute -left-7 top-[-20px] h-[calc(100%+40px)] w-3 -rotate-12 bg-gradient-to-b from-black via-[#15110b] to-black shadow-[14px_0_0_rgba(0,0,0,0.72)] sm:-left-4 sm:w-4"
        aria-hidden
      />
      <span
        className="absolute left-3 top-[-20px] h-[calc(100%+40px)] w-2 -rotate-12 bg-black/70 sm:left-7 sm:w-3"
        aria-hidden
      />
      <span
        className="absolute -right-7 top-[-20px] h-[calc(100%+40px)] w-3 rotate-12 bg-gradient-to-b from-black via-[#15110b] to-black shadow-[-14px_0_0_rgba(0,0,0,0.72)] sm:-right-4 sm:w-4"
        aria-hidden
      />
      <span
        className="absolute right-3 top-[-20px] h-[calc(100%+40px)] w-2 rotate-12 bg-black/70 sm:right-7 sm:w-3"
        aria-hidden
      />
      ...
      <span className="relative mx-auto inline-flex min-w-[12rem] items-center justify-center sm:min-w-[17rem]">
        <span
          className="absolute -left-4 top-1/2 h-9 w-8 -translate-y-1/2 bg-black [clip-path:polygon(100%_0,0_50%,100%_100%)] shadow-[0_8px_18px_rgba(0,0,0,0.35)] sm:-left-6 sm:h-11 sm:w-10"
          aria-hidden
        />
        <span
          className="absolute -right-4 top-1/2 h-9 w-8 -translate-y-1/2 bg-black [clip-path:polygon(0_0,100%_50%,0_100%)] shadow-[0_8px_18px_rgba(0,0,0,0.35)] sm:-right-6 sm:h-11 sm:w-10"
          aria-hidden
        />
