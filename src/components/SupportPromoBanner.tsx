  ...
  return (
    ...
    >
      ...
      <div className="relative flex w-full flex-col items-center justify-center gap-1">
        <span className="flex items-center justify-center gap-2 text-xs font-bold leading-none tracking-[0.28em] text-[#7b4f0b] drop-shadow-[0_1px_0_rgba(255,255,255,0.45)] sm:text-sm">
          <span>★</span>
          <span>★</span>
          <span className="font-serif text-base text-[#7b4f0b] drop-shadow-[0_0_8px_rgba(123,79,11,0.22)] sm:text-lg">
            ♛
          </span>
          <span>★</span>
          <span>★</span>
        ...
        <span className="relative inline-flex min-w-[12rem] items-center justify-center sm:min-w-[17rem]">
          <span
          ...
          <span
            ...
            aria-hidden
          />
          <span className="relative z-10 inline-flex items-center justify-center border border-black/80 bg-[linear-gradient(180deg,#2b2418_0%,#050505_44%,#1a140d_100%)] px-8 py-1 font-serif text-xl font-black tracking-[0.18em] text-gold-light shadow-[0_12px_30px_rgba(0,0,0,0.48),0_0_18px_rgba(0,0,0,0.25)] drop-shadow-[0_1px_0_rgba(255,255,255,0.18)] before:absolute before:inset-x-8 before:top-0 before:h-px before:bg-white/30 sm:px-14 sm:text-2xl">
            業界唯一
          </span>
        </span>

        <span className="max-w-[19rem] font-serif text-[2.15rem] font-black leading-[1.08] tracking-[0.14em] text-black [text-shadow:0_1px_0_rgba(255,255,255,0.55),0_2px_8px_rgba(0,0,0,0.16)] sm:max-w-none sm:whitespace-nowrap sm:text-[3.5rem] sm:leading-[1.08]">
          全掲載店舗
