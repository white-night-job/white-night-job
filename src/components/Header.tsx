  ...
  return (
    <header className="site-header sticky top-0 z-50">
      <div className="mx-auto flex h-[3.75rem] max-w-5xl items-center justify-between gap-3 px-4 sm:h-16 sm:gap-4 sm:px-8">
        ...
        >
          <span className="header-brand-emblem flex h-8 w-8 shrink-0 items-center justify-center rounded-full font-serif text-[10px] font-bold tracking-tight sm:h-[38px] sm:w-[38px] sm:text-[11.5px]">
            WN
          </span>
