...
const kita24joJobTypes = buildJobTypePages(
  ...
  },
  {
    "girls-bar": {
      ...
      desc: "北24条（24条）のガールズバー求人を掲載。地下鉄南北線沿いで通いやすい求人を、未経験歓迎などの条件から探せます。",
      intro: [
        "北24条（当サイトの地区名は「24条」）のガールズバー求人は、地下鉄南北線で通いやすい立地を活かし、学生やWワークの方が検討しやすいエリアです。",
...
export const DISTRICT_AREA_PAGES: DistrictAreaPage[] = [
  ...
  },
  {
    ...
    faqs: [
      {
        question: "北24条と24条は同じエリアですか？",
        answer:
          "当サイトでは求人の地区を「24条」として扱っています。ページ上では分かりやすく「北24条」と表記しています。",
      },
      {
